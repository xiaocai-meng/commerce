    ...
    <a class="brand" href="index.html"></a>
        ...
        <div class="span4 box">
            <div class="content-wrap">
                ...
                <?php echo $form->field($model, 'adminpassword')->passwordInput(["class"=>"span12","placeholder"=>"新密码"]);?>

                <?php echo $form->field($model, 'confirmPassword')->passwordInput(["class"=>"span12","placeholder"=>"确认密码"]);?>
