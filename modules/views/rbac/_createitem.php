...
<!--                                --><?php //echo $form->field($model, 'confirmPassword')->passwordInput(['class' => 'span9']); ?>
                                ...
                                <div class="span12 field-box">
                                    <?php
                                    //textInput第一个参数是name 第二个参数是value
                                    echo Html::label('名称', null).Html::textInput('name', '', ['class' => 'span9']);
                                    ?>
                                </div>
                                ...
                                <div class="span12 field-box">
                                    <?php
                                        ...
                                        echo Html::label('描述', null).Html::textInput('description', '', ['class' => 'span9']);
                                    ?>
                                </div>
                                ...
                                <div class="span12 field-box">
                                    <?php
                                        //textInput第一个参数是name 第二个参数是value
                                        echo Html::label('规则名称', null).Html::textInput('rule_name', '', ['class' => 'span9']);
                                    ?>
                                </div>
                                <div class="span12 field-box">
                                    <?php
                                        //textInput第一个参数是name 第二个参数是value
                                        echo Html::label('数据', null).Html::textarea('data', '', ['class' => 'span9']);
                                    ?>
                                </div>
