...
class AlipayPay {
     ...
     */
    public $partner = '2088621906129534';

    /**
     * @var String 收款支付宝账号
     */
    public $seller_email = '1026251951@qq.com';

    /**
     * @var String 安全检验码，以数字和字母组成的32位字符
     */
    public $key = 'lsby060wj8080vsmv02egbjy9rr8jh1p';
     ...
     */
    public $notify_url = 'http://meng.julyangel.cn/notify.php';

    /**
     * @var String 页面跳转同步通知页面路径
     * 需http://格式的完整路径，不能加?id=123这类自定义参数，不能写成http://localhost/
     */
    public $return_url = 'http://meng.julyangel.cn/index.php?r=pay/return';
