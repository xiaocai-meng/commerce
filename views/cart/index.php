...
<div class="container">
            ...
            <?php $total = 0; ?>
            <?php foreach ($this->params['cart']['products'] as $k => $product) : ?>
                ...
                <div class="row no-margin cart-item">
                    ...
                    <!--在layout1.php模板文件中有js发送get请求更新数据库-->
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <div class="quantity">
                            <div class="le-quantity">
                                    <a class="minus" href="#reduce" id="<?php echo $product['cartid']; ?>" num="<?php echo $product['productnum']; ?>"></a>
                                    <input name="productnum" id="<?php echo $product['cartid']; ?>" readonly="readonly" type="text" value="<?php echo $product['productnum']; ?>"  />
                                    <a class="plus" href="#add" id="<?php echo $product['cartid']; ?>" num="<?php echo $product['productnum']; ?>"></a>
                            </div>
                        </div>
                    </div>
