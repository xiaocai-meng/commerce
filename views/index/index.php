                ...
                <div class="side-menu animate-dropdown">
                    ...
                    <nav class="yamm megamenu-horizontal" role="navigation">
                        ...
                        ?>
                            ...
                            <!--使用bootstrap中的dropdown组件-->
                            <li class="dropdown menu-item">

                                <a href="<?php echo yii\helpers\Url::to(['product/index', 'cateid' => $top['id']]); ?>" class="dropdown-toggle" data-toggle="dropdown"><?php echo $top['title']; ?></a>
<!---->
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-lg-4">
                                                <ul>
                                                    ...
                                                    <?php
                                                    //循环遍历第二级子分类
                                                    foreach($top['twochildren'] as $child):
                                                    ?>
                        ...
                        <?php foreach($this->params['tui'] as $pro): ?>
                            ...
                            <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                                <div class="product-item">
                                    ...
                                    <div class="body">
                                        <div class="title">
                                            <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro->id]); ?>"><?php echo $pro->title; ?></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="hover-area">
                                        <div class="add-cart-button">
                                            <a href="<?php echo yii\helpers\Url::to(['cart/add', 'productid' => $pro->id]); ?>" class="le-button">加入购物车</a>
                                        </div>
                                    </div>
            ...
            <div class="product-grid-holder medium">
                    ...
                    <div class="row no-margin">
                        ...
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                            <div class="product-item">
                                ...
                                <div class="image">
                                    <img alt="<?php echo $this->params['all'][$i]->title; ?>" src="http://<?php echo $this->params['all'][$i]->cover; ?>-covermiddle" data-echo="http://<?php echo $this->params['all'][$i]->cover; ?>-covermiddle" />
                                </div>

                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
                                        <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $this->params['all'][$i]->id]) ?>"><?php echo $this->params['all'][$i]->title; ?></a>
                                    </div>
                                </div>

                                <div class="prices">
                                    <div class="price-current text-right">￥<?php echo $this->params['all'][$i]->saleprice; ?></div>
                                </div>

                                <div class="hover-area">
                                    <div class="add-cart-button">
                                        <a href="<?php echo yii\helpers\Url::to(['cart/add', 'productid' => $this->params['all'][$i]->id]); ?>" class="le-button">加入购物车</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xs-12 col-md-5 no-margin">
                    <div class="product-item-holder size-big single-product-gallery small-gallery">
                        ...
                        <?php
                        $last = $this->params['all'][count($this->params['all']) - 1];
                        //print_r((array)$last);
                        ?>

                        <div id="best-seller-single-product-slider" class="single-product-slider owl-carousel">

                            <!-- 使用jquery图片播放浏览插件prettyPhoto  -->
                            <div class="single-product-gallery-item" id="slide1">
                                <a data-rel="prettyphoto" href="http://<?php echo $last->cover; ?>">
                                    <img alt="<?php echo $last->title; ?>" src="http://<?php echo $last->cover; ?>-coverbig" data-echo="http://<?php echo $last->cover; ?>-coverbig" />
                                </a>
                            </div><!-- /.single-product-gallery-item -->

                            <?php
                            foreach ((array)json_decode($last->pics, true) as $k => $pic) :
                            ?>

                                <div class="single-product-gallery-item" id="slide<?php echo $k + 2; ?>">
                                    <a data-rel="prettyphoto" href="http://<?php echo $pic; ?>">
                                        <img alt="" src="http://<?php echo $pic; ?>-picbig" data-echo="http://<?php echo $pic; ?>-picbig" />
                                    </a>
                                </div><!-- /.single-product-gallery-item -->
                        ...
                        <!-- data-slide bootstramp的轮播功能 -->
                        <div class="gallery-thumbs clearfix">
                            <ul>
                                <li><a class="horizontal-thumb active" data-target="#best-seller-single-product-slider" data-slide="0" href="#slide1"><img alt="<?php echo $last->title; ?>" src="http://<?php echo $last->cover; ?>-coversmall" data-echo="http://<?php echo $last->cover; ?>-coversmall" /></a></li>

                                <?php foreach ((array)json_decode($last->pics, true) as $k => $pic) : ?>

                                <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="<?php echo $k + 1; ?>" href="#slide<?php echo $k + 2;  ?>"><img alt="" src="http://<?php echo $pic ?>-picsmall" data-echo="http://<?php echo $pic ?>-picsmall" /></a></li>
                        ...
                        <div class="body">
                            <div class="label-discount clear"></div>
                            <div class="title">
                                <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $last->id]); ?>"><?php echo $last->title; ?></a>
                            </div>
                        </div>
                        <div class="prices text-right">
                            <div class="price-current inline">￥<?php echo $last->saleprice; ?></div>
                            <a href="<?php echo yii\helpers\Url::to(['cart/add', 'productid' => $last->id]); ?>" class="le-button big inline">加入购物车</a>
                        </div>
                    </div><!-- /.product-item-holder -->
                </div><!-- /.col -->
