                ...
                <div class="search-area">
                    ...
                    ?>
                        <div class="control-group">
                            <input class="search-field" name="keyword" placeholder="搜索商品" value="<?php echo $this->params['keyword']; ?>"/>
                    ...
                    <div class="collapse navbar-collapse" id="mc-horizontal-menu-collapse">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <a href="<?php echo yii\helpers\Url::to(['product/index', 'cateid' => $top['id']]); ?>" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><?php echo $top['title']; ?></a>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-xs-12 col-sm-12">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <?php foreach ($top['twochildren'] as $child) : ?>
