        ...
        <div class="container">
            <div class="col-xs-12 no-margin">
                ...
                <section id="shipping-address" style="margin-bottom:100px;margin-top:-10px">
                    ...
                    <?php foreach ($addresses as $k => $address) : ?>
                        ...
                        <div class="row field-row" style="margin-top:10px">
                            ...
                            <div class="col-xs-12">
                                <input  class="le-radio big address" type="radio" id="address<?php echo $k;?>" name="address" value="<?php echo $address['addressid']; ?>" <?php if ($k == 0) { echo 'checked="checked"';} ?>/>
                            ...
                            <div class="col-xs-12 col-sm-9 ">
                                <div class="title">
                                    ...
                                    <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $product['productid']]); ?>" class="thumb-holder">
                                        <img class="lazy" alt="<?php echo $product['title']; ?>" src="http://<?php echo $product['cover'] ?>-coversmall" />
                                    </a>
                    ...
                    <div class="col-xs-12 col-lg-4 col-lg-offset-8 no-margin-right">
                        <div id="subtotal-holder">
                            <ul class="tabled-data inverse-bold no-border">
                                ...
                                <li>
                                    <label>商品总价</label>
                                    <div style="width:100%;text-align:right" class="value" id="total">￥ <span><?php echo $total; ?></span> </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div style="width:100%;text-align:right" class="value">
                                        ...
                                        <div class="radio-group">
                                            ...
                                            <input class="le-radio express" type="radio" name="expressid" value="<?php echo $k; ?>" data="<?php echo $expressPrice[$k]; ?>" <?php echo $checked; ?> />
                                                <div class="radio-label bold">
                                                    <?php echo $e; ?>
                                                    <span class="bold"> ￥ <?php echo $expressPrice[$k]; ?></span>
                                                </div>
                                                <br>
                                            <?php endforeach; ?>
                ...
                <div id="payment-method-options">
                        ...
                        <div class="payment-method-option">
                            <input class="le-radio" type="radio" name="paymethod" value="zhifubao" checked="checked" />
                            <div class="radio-label bold ">支付宝支付</div>
                        </div><!-- /.payment-method-option -->

                        <div class="payment-method-option">
                            <input class="le-radio" type="radio" name="paymethod" value="wangyin">
                ...
                <div class="place-order-button">
                    <button class="le-button big" type="submit">确认订单</button>
                </div><!-- /.place-order-button -->
