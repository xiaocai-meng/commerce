                ...
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div id="owl-single-product">
                        ...
                        <div class="single-product-gallery-item" id="slide1">
                            <a data-rel="prettyphoto" href="http://<?php echo $product['cover']; ?>-coverbig">
                                <img class="img-responsive" alt="<?php echo $product['title']; ?>" src="http://<?php echo $product['cover']; ?>-coverbig" data-echo="http://<?php echo $product['cover']; ?>-coverbig" />
                            </a>
                        ...
                        <div class="single-product-gallery-item" id="slide<?php echo $i; ?>">
                            <a data-rel="prettyphoto" href="http://<?php echo $pic; ?>-picbig">
                                <img class="img-responsive" alt="" src="http://<?php echo $pic; ?>-picbig" data-echo="http://<?php echo $pic; ?>-picbig" />
                            </a>
                        </div><!-- /.single-product-gallery-item -->
                    ...
                    <div class="single-product-gallery-thumbs gallery-thumbs">
                        ...
                        <div id="owl-single-product-thumbnails">
                           ...
                           <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="0" href="#slide1"><img alt="<?php echo $product['title']; ?>" src="http://<?php echo $product['cover']; ?>-coverbig" data-echo="http://<?php echo $product['cover']; ?>-coverbig" />

                            <?php $i = 2; ?>
                            <?php foreach ((array)json_decode($product['pics'], TRUE) as $k => $pic) : ?>
                            
                            <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="<?php echo $i - 1; ?>" href="#slide<?php echo $i; ?>">
                                <img width="67" alt="" src="http://<?php echo $pic ?>-picsmall" data-echo="http://<?php echo $pic ?>-picsmall" />
                            </a>
