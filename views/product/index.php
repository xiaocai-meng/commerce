                        ...
                        <li>
                            <div class="row">
                                ...
                                <div class="col-xs-4 col-sm-4 no-margin">
                                    <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro['id']]); ?>" class="thumb-holder">
                                        <img alt="" src="http://<?php echo $pro['cover']; ?>-coversmall" data-echo="http://<?php echo $pro['cover']; ?>-coversmall" />
                                    </a>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="no-margin col-xs-12 col-sm-5 body-holder">
                                                <div class="body">
                                                    ...
                                                    <div class="excerpt">
                                                        <p><?php echo mb_substr($pro['describe'], 0, 250, 'utf-8'); ?></p>
                                                    </div>
                                            ...
                                            <div class="no-margin col-xs-12 col-sm-3 price-area">
                                                ...
                                                <div class="right-clmn">
                                                    ...
                                                    <a class="le-button" href="<?php echo yii\helpers\Url::to(['cart/add', 'productid' => $pro['id']]); ?>">加入购物车</a>
                                                </div>
                                            </div><!-- /.price-area -->
                                        </div><!-- /.row -->
                                    </div><!-- /.product-item -->
